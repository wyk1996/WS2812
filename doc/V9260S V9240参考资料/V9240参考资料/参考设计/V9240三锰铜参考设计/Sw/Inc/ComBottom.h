...
const GS_BaudRate code BaudRateTable[5] =   //3.2M
{
   {0xe4,   0x82},  //600
   {0xf2,   0x82},  //1200
   {0xd5,   0x22},  //2400
...
const GS_BaudRate code BaudRateTable[5] =  //6.5M
{
   {0xc7,   0x82},  //600
   {0x55,   0x22},  //1200
   {0x55,   0xa2},  //2400
...
const GS_BaudRate code BaudRateTable[5] =  //13M
{
   {0x8e,   0x82},  //600
   {0xc7,   0x82},  //1200
   {0x55,   0x22},  //2400
...
#else
const GS_BaudRate code BaudRateTable[5] =  //26M
{
   {0x71,   0x02},  //600
   {0xC7,   0x02},  //1200
   {0xC7,   0x82},  //2400
