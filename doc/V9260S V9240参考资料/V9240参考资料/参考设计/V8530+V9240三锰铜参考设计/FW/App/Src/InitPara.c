...
//const uint8 InitPara0[]__attribute__((at(0x800)))=    //@0x800
//#pragma location = 0x800
__packed const uint8 InitPara0[] =
{
...
//const uint8 InitPara1[]__attribute__((at(0x83e)))=
//#pragma location = 0x840
__packed const uint8 InitPara1[] =
{
    0x00,'0','.','2',               //有功准确度等级
...
//const uint8 InitPara2[]__attribute__((at(0x87C)))=
//#pragma location = 0x880
__packed const uint8 InitPara2[] =
{
    0x80,0x00,  //校表脉冲宽度
    0x00,0x00,  //电表运行状态字1
    0x00,0x00,  //电表运行状态字2
...
//const uint8 InitPara3[]__attribute__((at(0x8BA)))=
//#pragma location = 0x8bc

__packed const uint8 InitPara3[] = // @ 0x8c0 =
{
...
//const uint8 InitPara4[]__attribute__((at(0x8F8)))=
//#pragma location = 0x900
__packed const uint8 InitPara4[] =
{
    0x00,                   //RTC温度常温偏移
...
//const uint8 InitPara5[sizeof(S_JBPM)-2]__attribute__((at(0x912)))=
//#pragma location = 0x920
__packed const uint8 InitPara5[sizeof(S_JBPM)-2] =
{
...
//    0x2B,0xDB,0x95,0x01,//2行 zzp1207
//    0x2B,0xDB,0x95,0x01,
    0xE8,0xC1,0xFE,0x03,//有功门限值寄存器  //5000次对应 0x0195db2b 
    0xE8,0xC1,0xFE,0x03,//无功门限值寄存器  //0x03fec1e8 为12600次/秒
...
//const uint8 InitPara7[]__attribute__((at(0x98c)))=
//#pragma location = 0x1000
__packed const uint8 InitPara7[] =
{
    0x02,                       //年时区数
    0x02,                       //日时段表数
    0x08,                       //日时段（每组合总电量日切换）
...
//const uint8 InitPara19[]__attribute__((at(0x1020)))=
//#pragma location = 0x1040
__packed const uint8 InitPara19[] =
{
    0x01,0x00,0x00,
    0x02,0x00,0x03,
    0x03,0x00,0x06,
...
//const uint8 InitPara27[]__attribute__((at(0x104a)))=
//#pragma location = 0x1070
__packed const uint8 InitPara27[] =
{
    //RDKWMNW60V1.0
...
//const uint8 InitPara28[]__attribute__((at(0x106A)))=
//#pragma location = 0x106a
__packed const uint8 InitPara28[] =
{
...
//const uint8 InitPara29[]__attribute__((at(0x108a)))=
//#pragma location = 0x1082
__packed const uint8 InitPara29[] = //@ 0x1090 =     //循环显示笔画
{
...
//const uint8 InitPara37[]__attribute__((at(0x1125)))=
//#pragma location = 0x112c
__packed const uint8 InitPara37[] =              //按键显示
{
...
//下面是为了对齐16保留部分
//const uint8 InitPara38[]__attribute__((at(0x11ca)))=
//#pragma location = 0x11d4
__packed const uint8 InitPara38[] =
{   //BGP Wkup LCD1 LCD2
...
void InitE2Data(uint8 uc_RTCSave)
{
    ...
    for(i=1;i<sizeof(PageCRCAddr)/sizeof(GS_E2PARA);i++)
    {
        ...
        //BE_ReadP(PageCRCAddr[i].E2Adrr,XDATA_RAMZONE2,PageCRCAddr[i].uclen+2); 
        //SysE2ReadData(EEP_MAX_LX_NUM,&gs_DispCont.ucLxCnt,sizeof(S_DISPCONTENT)-2);
        //BE_ReadP(EEP_MAX_LX_NUM+EEP_BAK_LEN,XDATA_RAMZONE2,PageCRCAddr[i].uclen+2);
     }
    ...
    for(i=0;i<((sizeof(InitPara29)-1)/64+1);i++)
    {
        ...
        //BE_ReadP(EEP_LXTABLE+i*64,XDATA_RAMZONE2,Wrlen);
        //SysE2ReadData(EEP_LXTABLE,&gs_DispCont.ucLxCnt,sizeof(S_DISPCONTENT)-2);
