...
//        p = guc_LCDRAM + NumAddr[i*2+4];
//        q = guc_LCDRAM + NumAddr[i*2+5]; 
        
//        q = guc_LCDRAM + NumAddr[15-2*i];
//        p = guc_LCDRAM + NumAddr[14-2*i]; 
        //第一个数显示对应NumAddr中的number1H和L
...
//        p = guc_LCDRAM + NumAddr[i*2+6];          
//        q = guc_LCDRAM + NumAddr[i*2+7]; 
        
//        p = guc_LCDRAM + NumAddr[15-2*i];
//        q = guc_LCDRAM + NumAddr[14-2*i]; 
