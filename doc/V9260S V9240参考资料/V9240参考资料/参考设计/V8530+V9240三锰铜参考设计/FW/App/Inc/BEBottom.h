...
#define BE_I2C_CLK_1()      {GPIOB->DAT|=BIT13; GPIOB->IE &=~BIT13; GPIOB->OEN &=~BIT13; }   //CLK=1   IOB13
#define BE_I2C_CLK_0()      {GPIOB->DAT&=~BIT13;GPIOB->IE &=~BIT13;GPIOB->OEN &=~BIT13; }   //CLK=0
...
#define BE_I2C_SDA_1()      {GPIOB->DAT |=BIT14; GPIOB->OEN &=~BIT14; }   //SDA=1 P9IE &=~BIT1;  IOB14
#define BE_I2C_SDA_0()      {GPIOB->DAT &=~BIT14;GPIOB->OEN &=~BIT14; }   //SDA=0 P9IE &=~BIT1;


#define BE_I2C_SDA_IN()     {GPIOB->OEN |=BIT14;GPIOB->IE |=BIT14;}                  //设置成输入模式
#define BE_I2C_SDA_ST       (GPIOB->STS&BIT14)                                 //读取数据线上的信号
